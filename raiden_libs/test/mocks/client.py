...
from raiden_libs.messages import BalanceProof, MonitorRequest, FeeInfo, PathsRequest, Message, \
    PathsReply
...
class MockRaidenNode:
    ...
    def on_paths_reply_message(self, pfs_reply: PathsReply):
        """Deserialize a PathsReply message. Returns the result for testing.
        """
        self.paths = pfs_reply.paths
